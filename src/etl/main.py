...
def main():
    ...
    add_col_name = os.getenv("ADD_COLUMN_NAME", "ingested_on")
    add_col_value = os.getenv("ADD_COLUMN_VALUE")  # optional literal
    ...
    df = add_column(df, add_col_name, add_col_value)
